...
import { createCompany, getCurrentCompany } from '../../actions/companyActions';
...
export default connect(mapStateToProps, { createCompany, getCurrentCompany })(withRouter(CreateCompany));
